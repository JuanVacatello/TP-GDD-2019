...
SELECT Cli_Nombre , Cli_Apellido , (SELECT direccion_id FROM LIL_MIX.direccion WHERE direccion_calle = Provee_Dom AND direccion_ciudad = Provee_Ciudad),
...
WHERE Tipo_Pago_Desc LIKE 'Crédito'
FROM gd_esquema.Maestra 
...
WHERE Tipo_Pago_Desc LIKE 'Efectivo'
FROM gd_esquema.Maestra
